...
| [SEC-017](done/SEC-017_ios-memory-zeroing-temp-file-cleanup.md) | iOS — zero DEK byte buffers after use and delete decrypted video temp files | Security | 2026-05-16 |
