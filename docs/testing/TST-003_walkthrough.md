...
| API key | `<REDACTED_ROTATE_PENDING>` — fetch: `gcloud secrets versions access latest --secret=heirlooms-test-api-key --project heirlooms-495416` |

Throughout this document:
- `$KEY` = value from `gcloud secrets versions access latest --secret=heirlooms-test-api-key --project heirlooms-495416`
...
-H "X-Api-Key: <REDACTED_ROTATE_PENDING>"
